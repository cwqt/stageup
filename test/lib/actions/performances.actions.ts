...
export default {
  ...
  readPerformances: async (): Promise<IEnvelopedData<IPerformanceStub[], null>> => {
    const res = await Axios.get(`${env.baseUrl}/performances`, env.getOptions());
    return res.data;
  },
  ...
  readPerformance: async (performance: IPerformance): Promise<IEnvelopedData<IPerformance, IPerformanceUserInfo>> => {
    const res = await Axios.get(`${env.baseUrl}/performances/${performance._id}`, env.getOptions());
    return res.data;
  },
  ...
  readPerformanceHostInfo: async (performance: IPerformance): Promise<IPerformanceHostInfo> => {
    const res = await Axios.get(`${env.baseUrl}/performances/${performance._id}/host_info`, env.getOptions());
    return res.data;
  },
  ...
  updatePerformance: async (
    ...
    const res = await Axios.put(`${env.baseUrl}/performance/${performance._id}`, data, env.getOptions());
    return res.data;
  },
  ...
  purchase: async (performance: IPerformance): Promise<void> => {
    const res = await Axios.post(
      `${env.baseUrl}/performances/${performance._id}/purchase`,
      performance,
      env.getOptions()
    );
    return res.data;
  ...
  deletePerformance: async (performance: IPerformance): Promise<void> => {
    const res = await Axios.delete(`${env.baseUrl}/performance/${performance._id}`, env.getOptions());
    return res.data;
  },
};
