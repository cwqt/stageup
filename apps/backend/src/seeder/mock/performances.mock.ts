...
export default to<Array<SeedMockPerformance>>([
  ...
  },
  {
    name: `Tempted`,
    publicity_period: { start: 1667260800, end: 1668538800 },
    short_description: `"Tempted is a forum theatre production that discusses sexual exploitation of young people – reflecting young people’s concerns and status. Produced in collaboration with Dyfed-Powys Police and crime commissioner. Tempted is currently nominated for two Arts & Business Cymru awards.
