...
import { AbstractHostAnalytics } from '../host-analytics-graphs/host-analytics-graphs.abstract';
...
export class HostEventAnalyticsGraphsComponent extends AbstractHostAnalytics implements OnInit {
